...
export function ChatMessage({ message }: { message: Message }) {
  if (message.role === "user") {
    return (
      <div className="flex justify-end">
        <div className="max-w-[85%] md:max-w-[75%] rounded-2xl rounded-br-md bg-primary px-4 py-2.5 text-primary-foreground shadow-sm">
  ...
  if (message.role === "tool_call") {
    return (
      <div className="flex justify-start">
        <div className="max-w-[95%] md:max-w-[85%] rounded-lg border border-amber-500/20 bg-amber-500/5 px-3.5 py-2.5">
  ...
  if (message.role === "tool_result") {
    return (
      <div className="flex justify-start">
        <div className="max-w-[95%] md:max-w-[85%] rounded-lg border border-emerald-500/20 bg-emerald-500/5 px-3.5 py-2.5">
          <div className="flex items-center gap-2 mb-1">
...
function AssistantMessage({ content }: { content: string }) {
  ...
  return (
    <div className="flex justify-start">
      <div className="max-w-[85%] md:max-w-[75%] rounded-2xl rounded-bl-md bg-muted/80 px-4 py-2.5 shadow-sm overflow-hidden">
        <MdPreview
          modelValue={content}
          theme={theme}
          previewTheme="github"
